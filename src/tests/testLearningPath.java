...
public class testLearningPath {
    ...
    public void testGetVersion(){
        assertEquals(4.5f, learningPath.getVersion());
    }
    ...
    public void testInscripcionEstudianteInvalidaPorOtroPath() {
        ...
        otroLearningPath.inscripcionEstudiante(estudiante1);
    ...
    @Test
    public void testEliminarInscripcionEstudianteInvalida() {
        assertThrows(IllegalArgumentException.class, () -> learningPath.eliminarInscripcion(estudiante1));
    }
